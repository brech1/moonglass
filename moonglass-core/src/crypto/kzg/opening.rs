...
//!
//! These primitives are currently unexercised by the reference test suite,
//! which covers only the cell and data availability sampling path. Treat them
//! as unverified cryptographic scaffolding for the external driver until
//! known answer coverage is added.
