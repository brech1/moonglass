...
/// Data-column index used by availability sampling.
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
...
/// Matrix-row index used by data availability recovery.
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct RowIndex(pub u64);

impl RowIndex {
    /// Construct from a raw row index.
    #[inline]
    pub const fn new(value: u64) -> Self {
        Self(value)
    }
...
/// Custody group index used by data availability sampling.
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct CustodyIndex(pub u64);

impl CustodyIndex {
    /// Construct from a raw custody group index.
    #[inline]
    pub const fn new(value: u64) -> Self {
        Self(value)
    }

    /// Return the raw custody group index.
    #[inline]
    pub const fn as_u64(self) -> u64 {
        self.0
    }
...
impl SubnetId {
    /// Construct from a raw subnet index.
    #[inline]
    pub const fn new(value: u64) -> Self {
        Self(value)
    }

    /// Return the raw subnet index.
    #[inline]
    pub const fn as_u64(self) -> u64 {
        self.0
    }
...
/// Cell index within the extended blob domain.
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct CellIndex(pub u64);

impl CellIndex {
    /// Construct from a raw cell index.
    #[inline]
    pub const fn new(value: u64) -> Self {
        Self(value)
    }

    /// Return the raw cell index.
    #[inline]
    pub const fn as_u64(self) -> u64 {
        self.0
    }
...
/// Index into a deduplicated KZG commitment list.
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct CommitmentIndex(pub u64);

impl CommitmentIndex {
    /// Construct from a raw commitment index.
    #[inline]
    pub const fn new(value: u64) -> Self {
        Self(value)
    }

    /// Return the raw commitment index.
    #[inline]
    pub const fn as_u64(self) -> u64 {
        self.0
    }
